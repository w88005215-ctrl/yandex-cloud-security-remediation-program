...
- Retained resources: bootstrap registry, audit trail, bootstrap service accounts, and federation remain intentionally retained until the final cleanup phase.
